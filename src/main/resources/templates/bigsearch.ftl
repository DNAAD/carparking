...
<div class=" well " data-offset-top="100" ><!--data-spy="affix"-->
        ...
        <div class="col-sm-12">
            ...
            <div class="tab-box ">
                ...
                <ul class="nav nav-tabs add-tabs" id="ajaxTabs" role="tablist">
                    ...
                    <li class=""><a href="#capacities" data-url="ajax/3.html" role="tab" data-toggle="tab" aria-expanded="true">运输 <span class="badge"></span></a></li>
                </ul>
            ...
            <div class="listing-filter">
             ...
             <div  class="tab-content">
                    ...
                    <div class="tab-pane active" id="companies">
                        <table class=" table-striped" id="companies-table" data-url="${companiesUrl}" data-toggle="table" data-classes="table table-hover"   data-method="POST"
                    ...
                    <div class="tab-pane" id="capacities">
                        ...
                        <table class=" table-striped" id="capacity-table" data-url=" {capacitiesUrl}" data-toggle="table" data-classes="table table-hover"   data-method="POST"
                           data-content-type="application/x-www-form-urlencoded; charset=UTF-8"
                           data-query-params-type="unlimit"
                        ...
                        <thead>
                        <tr>
                            <th data-field="companyName | senderCompanyName"  data-formatter="ompanyInfoFormatter">承运公司</th>

                            <th data-field="origin" data-formatter="originToDestinationInfoFormatter">出发地</th>
