            ...
            <div class="listing-filter">
             ...
             <div  class="tab-content">
                    ...
                    <div class="tab-pane active" id="companies">
                        ...
                        <table class=" table-striped" id="station-table" data-url="${linesSchedulesUrl}" data-toggle="table" data-classes="table table-hover"   data-method="GET"
                    ...
                    <div class="col-xs-12">
                        <div class="well">
                            ...
                            <form id="addStationModalForm"   novalidate="novalidate" action="${command_create_url}">
                                ...
                                <div class="form-group">
                                    <label for="username" class="control-label">计划</label>

                                    <select class="selectpicker" <#--data-max-options="2" --> id="tripId" name="tripId" class="form-control" placeholder="特征">
                                    <#-- <select class="form-control select2" id="userType" name="userType"  placeholder="公司类型"  multiple="multiple">-->

                                    <#if trips??>
                                        <#list trips as feature>
                                ...
                                <div class="form-group">
                                    <label for="username" class="control-label">站台</label>

                                    <select class="selectpicker" <#--data-max-options="2" --> id="stationId" name="stationId" class="form-control" placeholder="特征">
                                    <#-- <select class="form-control select2" id="userType" name="userType"  placeholder="公司类型"  multiple="multiple">-->
