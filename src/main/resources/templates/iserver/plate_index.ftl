        ...
        <div class="col-sm-12">
            ...
            <div class="tab-box ">
             ...
             <div  class="tab-content">
                 <div id="toolbar" class="" style="padding-top: 10px;padding-bottom: 10px">
                    ...
                    <div class="tab-pane active" id="companies">
                        <table class=" table-striped" id="companies-table" data-url="${lprUrl}" data-toggle="table" data-classes="table table-hover"   data-method="GET"
