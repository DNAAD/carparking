...
while True:
    ...
    if ret == True:
        ...
        crop_frame = frame[0:0+500, 0:0+800]
        crop_frame_2 = frame[0:0+500, 800:800+800]
        crop_frame_1 = frame[500:500+500, 800:800+800]
        count +=1
        if count%150 == 1:
        ...
        cv2.imshow("Output", crop_frame)
        cv2.imshow("Outputcrop_frame_2", crop_frame_2)
        cv2.imshow("Outputcrop_frame_1", crop_frame_1)
