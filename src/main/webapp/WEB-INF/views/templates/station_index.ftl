             ...
             <div  class="tab-content">
                    ...
                    <div class="tab-pane active" id="companies">
                        ...
                        <div id="toolbar" class="btn-group" style="padding-top: 10px;padding-bottom: 10px">
                            ...
                            <button id="editMapBtn" type="button" class="btn btn-primary"  >
                            ...
                            <script type="text/javascript">
                                ...
                                $("#editMapBtn").click(function() {
                                    ...
                                    if (row != '') {
                                        ...
                                        window.location.href ="${map_config_url}"+"?id="+row[0].id;
                        ...
                        <div class="well">
                            ...
                            <form id="addStationModalForm"   novalidate="novalidate" action="${command_create_url}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker" <#--data-max-options="2" --> id="locationId" name="locationId" class="form-control" placeholder="特征">
                                    <#-- <select class="form-control select2" id="userType" name="userType"  placeholder="公司类型"  multiple="multiple">-->

                                    <#if locations??>
                                        <#list locations as feature>
