...
<div class="row">
    ...
    <script>
        if(Hls.isSupported()) {
            var source_url = 'http://192.168.43.183/hls/fridgecast.m3u8';
    ...
    <div class="col-lg-12">
        ...
        <div class="well well-lg">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                <tr class="infoRow">
<#--                    <td>${camera.createDate!''}</td>
                    <td>${camera.type!''}</td>
                    <td>${camera.note!''}</td>

                    <td>${camera.amount!''} 吨</td>-->
...
<script type="text/javascript">
    ...
    $(".immediatePay").on('click', function(){
        window.location.href = '/usercenter/cashier?paymentId=' + camera.id!''} ;
    });
