...
public class MobileTraderController {
    private static final Logger logger = LoggerFactory.getLogger(MobileTraderController.class);
    ...
    public ModelAndView searchCompanies(@RequestParam(value = "q", required = false) String searchTerm){//,Authentication authentication)  {
        ...
        String companiesUrl = linkTo(methodOn(MobileTraderController.class).stations("", null)).withSelfRel().getHref();
        ...
        String command_create_url = linkTo(methodOn(MobileTraderController.class).create(null, null)).withSelfRel().getHref();
        modelAndView.addObject("command_create_url",command_create_url);


        String command_edit_url = linkTo(methodOn(MobileTraderController.class).edit(null, null,null)).withSelfRel().getHref();
