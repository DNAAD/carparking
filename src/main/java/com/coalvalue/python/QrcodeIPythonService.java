 ...
 */
@Component
public class QrcodeIPythonService implements IPythonService{
    ...
    public void execute(){
        ...
        Resource res = resourceLoader.getResource("classpath:proto/"+name);
        ...
        try {
            ...
            System.out.println("执行任务E:\\carparking\\src\\main\\resources\\proto\\"+res.getFile().getCanonicalPath());
        } catch (IOException e) {
            e.printStackTrace();
        }
