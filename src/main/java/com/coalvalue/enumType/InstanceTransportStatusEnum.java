 ...
 */
public enum InstanceTransportStatusEnum {
    ...
    private InstanceTransportStatusEnum(String statusText, String displayText, Integer id, String helpMessage) {
    ...
    public static List<ListItem> retriveTypese() {
        ...
        for (InstanceTransportStatusEnum status : InstanceTransportStatusEnum.values()) {
    ...
    public static InstanceTransportStatusEnum fromString(String text) {
        for (InstanceTransportStatusEnum status : InstanceTransportStatusEnum.values()) {
    ...
    public static List<ListItem> retriveTypese(List<InstanceTransportStatusEnum> transportOperationStatusEnums) {

        List<ListItem> list = new ArrayList<ListItem>();
        for(InstanceTransportStatusEnum status : transportOperationStatusEnums) {
            ListItem element = new ListItem(status.getText(), status.getDisplayText());
