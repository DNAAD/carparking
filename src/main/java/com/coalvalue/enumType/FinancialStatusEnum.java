...
public enum FinancialStatusEnum {
  ...
  //  会将该笔资金从“应收账款”或者“待清算账款
    ...
    private FinancialStatusEnum(String statusText, String displayText, Integer id, String helpMessage) {
    ...
    public static FinancialStatusEnum fromString(String text) {
        for (FinancialStatusEnum status : FinancialStatusEnum.values()) {
    ...
    public static List<String> toStringList(List<FinancialStatusEnum> created) {

        List<String> status = new ArrayList<>();
        for(FinancialStatusEnum canvassingStatusEnum : created){
